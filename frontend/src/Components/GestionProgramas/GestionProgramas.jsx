...
import { programas } from "./mockData";

function GestionProgramas() {

    const busquedaDepartamento = (
        <div className="col-12 -ml-2">
            <label className='block mb-2'>Programas Registrados:</label>
    ...
    return (
        <div className='grid col-11 md:col-11 mx-auto p-4 p-fluid bg-gray-50 border-round shadow-1 mb-4'>
            <div className='col-12 text-center'>
                <h1 className=' mb-0 text-black-alpha-80'>Gestion de Programas</h1>
            </div>
            ...
            <div className='col-12 flex flex-wrap'>
                <form className='col-12 md:w-auto md:mr-2' >
                    ...
                    <div className='field w-full'>
                        <label htmlFor='contrasenia' className='font-bold text-black-alpha-70 block'>Departamento:</label>
                        <Dropdown
                            inputId="programa" 
                            options={[]} 
                            optionLabel='nombre'
                ...
                <div className='col-12 md:col'>
                    ...
                    >
                        <Column field="nombre" header="Programa"/>
